	...
	var imageDialog = function( editor, dialogType ) {
			...
			return {
				...
				onShow: function() {
					...
					console.log(element)
moduleAdapter.SetPic(this.getContentElement('info','txtUrl').getInputElement().$.id,this.toadapter);moduleAdapter.AppendLinks(this.getContentElement('Link', 'txtUrl').getInputElement().$.id, undefined ,element);
				...
				onOk: function() {
					...
					if ( this.imageEditMode ) {
						...
						if ( dialogType == 'image' && imgTagName == 'input' && confirm( editor.lang.image.button2Img ) ) { // jshint ignore:line
							...
							moduleAdapter.setAttributeLinks(this.imageElement)
          ...
          moduleAdapter.WPfullsizeA(this.imageElement)
                        moduleAdapter.WPpostlinkA(this.imageElement)
